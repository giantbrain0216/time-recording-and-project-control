<template lang="html">
  ...
  <div id="parentx">
    <vs-sidebar default-index="1" :parent="parent" :hiddenBackground="doNotClose" color="primary" class="sidebarx"
                spacer v-model="isSidebarActive" :click-not-close="doNotClose">
      <template v-for="(sidebarLink, index) in sidebarLinks">
       ...
       <div class="footer-sidebar" slot="footer">
        <vs-button class="mb-2" icon="event_note" color="primary" type="flat" style="width: 100%;text-align: left"
