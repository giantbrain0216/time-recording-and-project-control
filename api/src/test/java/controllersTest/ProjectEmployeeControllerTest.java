...
public class ProjectEmployeeControllerTest {
    ...
    public void getAllProjectsTest() throws Exception {
        this.mockMvc.perform(get("/projects")).andDo(print()).andExpect(status().isOk())
                .andExpect(content().string(containsString("Muster Project")));
    }
    ...
    public void getClientTest() throws Exception {
        ...
        this.mockMvc.perform(get("/projects/1")).andDo(print()).andExpect(status().isOk())
                .andExpect(content().string(containsString("Muster Project")));
    }
