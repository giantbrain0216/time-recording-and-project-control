...
@OpenAPIDefinition(info = @Info(title = " SoPra WS2021 REST API", version = "1.3",
        description = "The REST API Documentation. Methods to " +
                "create, read, update and delete each entity have been implemented. Many methods have been implemented to manipulate the de.unistuttgart.sopra.entities themselves. Others, however, were implemented because they were needed and contributed to the realization of logical relations between de.unistuttgart.sopra.entities."))
